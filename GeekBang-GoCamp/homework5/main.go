...
import (
	...
	"github.com/linliuliu/GeekBang-GoCamp/homework5/pkg/apis"
)
...
func main() {
	...
	calc := &Calc{}
	rk := &FatRateRank{}
	records := NewRecord("D:\\GoProject\\src\\github.com\\linliuliu\\GeekBang-GoCamp\\records.txt")
...
func caseStudy() {
	filePath := "D:\\GoProject\\src\\github.com\\linliuliu\\GeekBang-GoCamp\\test.json"
